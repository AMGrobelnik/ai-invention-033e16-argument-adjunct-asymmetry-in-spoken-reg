...
- **2. test_idea** — `invention_loop`
  - round_1
    ...
    - `2_gen_plan/` — 3 task(s)
      ...
      - `prompts/2_test_idea/round_1/2_gen_plan/gen_plan_evaluation_1.md` — 4 prompt(s)
      - `prompts/2_test_idea/round_1/2_gen_plan/gen_plan_experiment_1.md` — 3 prompt(s)
    - `3_gen_art/` — 3 task(s)
      - `prompts/2_test_idea/round_1/3_gen_art/gen_art_dataset_1.md` — 13 prompt(s)
      - `prompts/2_test_idea/round_1/3_gen_art/gen_art_evaluation_1.md` — 11 prompt(s)
  ...
  - round_2
    ...
    - `prompts/2_test_idea/round_2/6_upd_hypo.md` — 4 prompt(s)
- **3. report_results** — `gen_paper_repo`
  ...
  - `2_gen_demo_art/` — 6 task(s)
    ...
    - `prompts/3_report_results/2_gen_demo_art/gen_demo_art_evaluation_2.md` — 3 prompt(s)
    - `prompts/3_report_results/2_gen_demo_art/gen_demo_art_experiment_1.md` — 4 prompt(s)
    - `prompts/3_report_results/2_gen_demo_art/gen_demo_art_experiment_2.md` — 5 prompt(s)
